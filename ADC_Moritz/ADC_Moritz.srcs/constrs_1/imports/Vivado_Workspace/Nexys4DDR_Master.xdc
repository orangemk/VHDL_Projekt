...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { LED1 }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
...
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS18 } [get_ports { AUD_PWM }]; #IO_L4N_T0_15 Sch=aud_pwm
