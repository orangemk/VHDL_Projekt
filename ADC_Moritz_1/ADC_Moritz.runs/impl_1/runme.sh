...
HD_PWD='C:/VHDL/ADC_Moritz - Kopie - Kopie/ADC_Moritz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log steuerung.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source steuerung.tcl -notrace
