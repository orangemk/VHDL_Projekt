...
HD_PWD='C:/VHDL/ADC_Moritz - Kopie - Kopie/ADC_Moritz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log steuerung.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source steuerung.tcl
