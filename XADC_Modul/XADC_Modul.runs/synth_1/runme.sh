...
HD_PWD='C:/Users/Dominik/Vivado_Workspace/XADC_Modul/XADC_Modul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC.tcl
